...
CREATE TABLE `acteurs` (
  ...
  `Decennia` int(11) DEFAULT NULL,
  `Kleur` int(11) DEFAULT NULL,
...
INSERT INTO `acteurs` (`id`, `Voornaam`, `Achternaam`, `Decennia`, `Kleur`, `Grootte`, `Rating`, `AfbeeldingURL`) VALUES
(1, 'g', 'h', NULL, NULL, NULL, NULL, NULL);
...
INSERT INTO `Films` (`id`, `Naam`, `Bestandsnaam`) VALUES
(1, 'ffdf', 'df');
